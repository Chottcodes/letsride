  ...
  return (
    <SafeAreaView style={styles.SafeAreaViewContainer}>
        ...
        <CustomeScreen Style={styles.ViewContainer} number={50}>
            ...
            <Text style={styles.LetsText} >LETS <Text style={styles.RideText}>RIDE</Text></Text>
            ...
            <CustomeInput
              ...
              imageSource3={require("../../assets/images/hide.png")}
            />
            <CustomeButton fontStyle={{fontFamily}} title="Sign Up" backgroundColor="black" onPress={()=>{}}/>
            </View>
        </CustomeScreen>
    </SafeAreaView>
  );
